...
import (
	...
	"github.com/celer-network/intent-rfq-mm/example-mm/mm"
...
func NewRootCmd() *cobra.Command {
	...
	rootCmd.PersistentFlags().String(FlagHome, os.ExpandEnv("$HOME/.intent-rfq-mm"), "home path")
	rootCmd.PersistentFlags().String(FlagLoglevel, "info", "log level")
	rootCmd.PersistentFlags().String(FlagLogDir, "$HOME/.intent-rfq-mm/app", "log level")
	rootCmd.AddCommand(
		startCmd(),
	)
	return rootCmd
